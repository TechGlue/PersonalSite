    ...
    <>
      <div className="mx-32">
        <div className="pb-4">
          ...
          <p className="border-r-white pr-3 text-1xl whitespace-nowrap"> (Loo-eece) </p>
          <img
            src={image}
            alt="my-prof"
        ...
        <p>
          ...
          work but has a strong passion and curiosity for other technologies
          that changes the way I approach problems and overall pushes me to get
          out of my shell.
        </p>
        <br />
        ...
        <p>
          ...
          free time on anything big or small. I ended up graduating and starting
          my first Software Engineering position at Premera Blue Cross in the
          Fall of 2023.
        </p>
        <p className="mt-2">
          ...
          took to get here. Right now, my main goal is to grow as a developer by
          continuing to push myself to learn new things and hopefully help
